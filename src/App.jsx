    ...
    <>
      ...
      <header className="header">
        <div className="header-inner">
          <div className="logo" onClick={() => nav({ type: "home" })}>
          ...
          <nav className="nav-desktop">
            <span className={`nav-item ${currentPage.type === "home" ? "active" : ""}`} onClick={() => nav({ type: "home" })}>Home</span>
            <div className="nav-dropdown">
              ...
              <div className="dropdown-menu">
                ...
                {COMMERCIAL_SERVICES.map(s => <a key={s.key} className="dropdown-item" onClick={() => nav({ type: "service", key: s.key })}>🏢 {s.name}</a>)}
                <div className="dropdown-section">Residential</div>
                {RESIDENTIAL_SERVICES.map(s => <a key={s.key} className="dropdown-item" onClick={() => nav({ type: "service", key: s.key })}>🏠 {s.name}</a>)}
                <div className="dropdown-section">Shower Doors</div>
                {SHOWER_SERVICES.map(s => <a key={s.key} className="dropdown-item" onClick={() => nav({ type: "service", key: s.key })}>🚿 {s.name}</a>)}
                <div className="dropdown-section">Foggy Windows</div>
                <a className="dropdown-item" style={{ fontWeight: 700, color: "#0F4C81" }} onClick={() => nav({ type: "foggy-window" })}>🌫️ Foggy Window / Broken Seal Repair</a>
              </div>
            </div>
            <div className="nav-dropdown">
              ...
              <div className="dropdown-menu" style={{ minWidth: 260 }}>
                ...
                <a className="dropdown-item" style={{ fontWeight: 700, color: "#0F4C81" }} onClick={() => nav({ type: "foggy-window" })}>🌫️ All Foggy Window Repair</a>
                <a className="dropdown-item" onClick={() => nav({ type: "service", key: "foggy-window-repair" })}>💧 Foggy Window Repair</a>
                <a className="dropdown-item" onClick={() => nav({ type: "service", key: "broken-seal-repair" })}>🔧 Broken Seal Repair</a>
                <a className="dropdown-item" onClick={() => nav({ type: "service", key: "igd-replacement" })}>🪟 IGU Replacement</a>
                <a className="dropdown-item" onClick={() => nav({ type: "service", key: "double-pane-replacement" })}>⚡ Double Pane Replacement</a>
                <a className="dropdown-item" onClick={() => nav({ type: "service", key: "low-e-glass" })}>🌟 Low-E Glass Upgrade</a>
                <div className="dropdown-section">Foggy Window — By City</div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "0 8px" }}>
                  {FOGGY_CITIES.map(c => <a key={c.key} className="dropdown-item" onClick={() => nav({ type: "foggy-city", key: c.key })}>{c.name}</a>)}
                </div>
              </div>
            </div>
            <span className={`nav-item ${currentPage.type === "gallery" ? "active" : ""}`} onClick={() => nav({ type: "gallery" })}>Gallery</span>
            <div className="nav-dropdown">
              ...
              <div className="dropdown-menu" style={{ minWidth: 280 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "0 8px" }}>
                  {CITIES.map(c => <a key={c.key} className="dropdown-item" onClick={() => nav({ type: "city", key: c.key })}>{c.name}</a>)}
                </div>
              </div>
            </div>
            <span className={`nav-item ${currentPage.type === "blog" ? "active" : ""}`} onClick={() => nav({ type: "blog" })}>Blog</span>
            <span className={`nav-item ${currentPage.type === "contact" ? "active" : ""}`} onClick={() => nav({ type: "contact" })}>Contact</span>
          </nav>
      ...
      <div className={`mob-menu ${menuOpen ? "open" : ""}`}>
        ...
        <div className="mob-sec">
          ...
          <div className="mob-lnk" onClick={() => nav({ type: "home" })}>🏠 Home <span style={{color:"#ccc"}}>›</span></div>
          <div className="mob-lnk" onClick={() => nav({ type: "gallery" })}>📷 Project Gallery <span style={{color:"#ccc"}}>›</span></div>
          <div className="mob-lnk" onClick={() => nav({ type: "blog" })}>📰 Blog <span style={{color:"#ccc"}}>›</span></div>
          <div className="mob-lnk" onClick={() => nav({ type: "contact" })}>📨 Contact / Free Estimate <span style={{color:"#ccc"}}>›</span></div>
        </div>
        <div className="mob-divider" />
        <div className="mob-sec">
          <div className="mob-sec-title">Commercial Services</div>
          {COMMERCIAL_SERVICES.map(s => <div key={s.key} className="mob-sub" onClick={() => nav({ type: "service", key: s.key })}>🏢 {s.name}</div>)}
        </div>
        <div className="mob-divider" />
        <div className="mob-sec">
          <div className="mob-sec-title">Residential &amp; Shower</div>
          {RESIDENTIAL_SERVICES.map(s => <div key={s.key} className="mob-sub" onClick={() => nav({ type: "service", key: s.key })}>🏠 {s.name}</div>)}
          {SHOWER_SERVICES.map(s => <div key={s.key} className="mob-sub" onClick={() => nav({ type: "service", key: s.key })}>🚿 {s.name}</div>)}
        </div>
        <div className="mob-divider" />
        <div className="mob-sec">
          <div className="mob-sec-title">🌫️ Foggy Window Repair</div>
          <div className="mob-sub" style={{ fontWeight: 700, color: "#0F4C81" }} onClick={() => nav({ type: "foggy-window" })}>🌫️ All Foggy Window Services</div>
          {FOGGY_CITIES.map(c => <div key={c.key} className="mob-sub" onClick={() => nav({ type: "foggy-city", key: c.key })}>📍 {c.name} Foggy Windows</div>)}
        </div>
        <div className="mob-divider" />
        <div className="mob-sec">
          <div className="mob-sec-title">Service Areas</div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
            {CITIES.map(c => <div key={c.key} className="mob-sub" onClick={() => nav({ type: "city", key: c.key })}>📍 {c.name}</div>)}
          </div>
        </div>
        <div style={{ height: 48 }} />
      </div>
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Commercial</h4>
            {COMMERCIAL_SERVICES.map(s => <a key={s.key} onClick={() => setPage({ type: "service", key: s.key })}>{s.name}</a>)}
          </div>
          <div className="footer-col">
            <h4>Residential</h4>
            {RESIDENTIAL_SERVICES.map(s => <a key={s.key} onClick={() => setPage({ type: "service", key: s.key })}>{s.name}</a>)}
            <h4 style={{ marginTop: 16 }}>Shower Doors</h4>
            {SHOWER_SERVICES.map(s => <a key={s.key} onClick={() => setPage({ type: "service", key: s.key })}>{s.name}</a>)}
          </div>
          <div className="footer-col">
            <h4>Service Areas</h4>
            {CITIES.map(c => <a key={c.key} onClick={() => setPage({ type: "city", key: c.key })}>{c.name}</a>)}
            <a onClick={() => setPage({ type: "gallery" })} style={{ marginTop: 8, color: "#FFD700" }}>📷 Project Gallery</a>
            <h4 style={{ marginTop: 14, color: "#FFD700" }}>🌫️ Foggy Windows</h4>
            <a onClick={() => setPage({ type: "foggy-window" })} style={{ color: "#FFD700" }}>Foggy Window Repair</a>
            {FOGGY_CITIES.slice(0, 8).map(c => <a key={c.key} onClick={() => setPage({ type: "foggy-city", key: c.key })}>{c.name} Foggy Windows</a>)}
          </div>
        </div>
...
export default function App() {
  ...
  const renderPage = () => {
    if (page.type === "home") return <HomePage setPage={setPage} />;
    if (page.type === "service") {
      const svc = ALL_SERVICES.find(s => s.key === page.key) || ALL_SERVICES[0];
      return <ServicePage svc={svc} setPage={setPage} />;
    }
    if (page.type === "city") {
      const city = CITIES.find(c => c.key === page.key) || CITIES[0];
      return <CityPage city={city} setPage={setPage} />;
    }
    if (page.type === "foggy-window") return <FoggyWindowPage setPage={setPage} />;
    if (page.type === "foggy-city") {
      const city = FOGGY_CITIES.find(c => c.key === page.key) || FOGGY_CITIES[0];
      return <FoggyCityPage city={city} setPage={setPage} />;
    }
    if (page.type === "gallery") return <GalleryPage />;
    if (page.type === "blog") return <BlogPage setPage={setPage} />;
